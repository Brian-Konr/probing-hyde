...
import pandas as pd
from utils import init_model, load_config, get_probe_path, load_threshold, select_device
...
def main():
    ...
    probe_path = get_probe_path(probe_path, sanitized_model_name, layer)
    ...
    results_path = os.path.join(results_dir, f"prediction_results_{sanitized_model_name}.csv")
    # results_path = os.path.join(os.getcwd(), f"/prediction/prediction_results_{sanitized_model_name}.csv" )
